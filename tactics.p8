...
function selectdraw()
  ...
  spr(63, screenpos.x * 8, screenpos.y * 8)
...
function exploremoves(x, y, passable, obstacles, attacking)
  return explorerange(g_chosen.x, g_chosen.y, g_chosen.speed, 62, passable, obstacles, true, attacking)
end
...
function exploreattacks(targets)
  local attackspaces = minmaxrange(g_chosen.x, g_chosen.y, g_chosen.attackmin, g_chosen.attackmax, 0, 61, targets, {}, true, true)
...
function attack(target)
  ...
  local g_spaces = minmaxrange(g_enemy.x, g_enemy.y, g_enemy.attackmin, g_enemy.attackmax, 0, 61, counteralignment, {}, true, true)
...

...

...
__map__

...

...

